...
class TestLogin:
    ...
    def test_login_positive(self, pages, email, password):
        ...
        assert True == pages.loginpage.login_status(
            email), f"failed to login with {email, password}"
    ...
    def test_login_negative(self, pages, email, password):
        ...
        pages.loginpage.login(email, password)
        print(pages.loginpage.login_status(email))
        assert False == pages.loginpage.login_status(
            email), f"Login with invalid details {email, password}"
